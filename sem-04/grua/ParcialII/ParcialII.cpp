// ParcialII.cpp : define los comportamientos de las clases para la aplicación.
//
...
// El único objeto CParcialIIApp

CParcialIIApp theApp;


// Inicialización de CParcialIIApp
