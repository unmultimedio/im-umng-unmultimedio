================================================================================
    BIBLIOTECA MICROSOFT FOUNDATION CLASS: Información general del proyectoParcialII
===============================================================================

El Asistente para aplicaciones ha creado esta aplicación ParcialII.  Esta aplicación no sólo muestra los fundamentos del uso de Microsoft 
...
constituyen su aplicación ParcialII.
...
res\ParcialII.ico
    ...
    icono está incluido en el archivo principal de recursos ParcialII.rc.
...
res\Toolbar.bmp
    ...
    actualice la matriz IDR_MAINFRAME TOOLBAR en ParcialII.rc para agregar botones de barra de herramientas.
/////////////////////////////////////////////////////////////////////////////

El Asistente para aplicaciones crea un tipo de documento y una sola vista:

ParcialIIDoc.h, ParcialIIDoc.cpp – el documento
    Estos archivos contienen su clase CParcialIIDoc.  Edite estos archivos para 
    agregar los datos del documento especial y para guardar y cargar el archivo 
    (mediante CParcialIIDoc::Serialize).

ParcialIIView.h, ParcialIIView.cpp – la vista del documento
    Estos archivos contienen su clase CParcialIIView.
    Los objetos CParcialIIView se utilizan para ver objetos CParcialIIDoc.
...
StdAfx.h, StdAfx.cpp
    ...
    denominado ParcialII.pch y un archivo de tipos precompilado llamado StdAfx.obj.
