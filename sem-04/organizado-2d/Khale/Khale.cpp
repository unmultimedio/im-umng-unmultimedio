// Khale.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CKhaleApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CKhaleApp::OnAppAbout)
...
// El único objeto CKhaleApp

CKhaleApp theApp;


// Inicialización de CKhaleApp

BOOL CKhaleApp::InitInstance()
{
...
// Controladores de mensaje de CKhaleApp
